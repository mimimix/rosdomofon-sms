...
#CURL_OPTS="-L -s -S -m 60 -A 'Mozilla/5.0' -k "
IP_ADDRESS=$1
LOGIN_ADMIN_USER="$2"
...
echo "xxxxxxx ${LOGIN_ADMIN_PASSWORD_BASE64}"
echo "xxxxxxx ${ADMIN_USER_PASSWORD_TOKEN}"
echo "xxxxxxx ${ADMIN_USER_PASSWORD_TOKEN_BASE64}"
}
